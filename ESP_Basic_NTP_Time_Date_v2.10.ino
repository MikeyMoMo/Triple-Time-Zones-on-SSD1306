...
const char * TopTZ = "PST8PDT,M3.2.0,M11.1.0";  // The lengths must all be equal to the longest one
const char * BotTZ = "PHT-8                 ";  // The lengths must all be equal to the longest one
...
const int displayLine1 =  0;  // These numbers are for the 2-color SSD1306
